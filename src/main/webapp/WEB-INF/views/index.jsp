...
<jsp:include page="header.jsp">
	<jsp:param value="Home Page" name="pageTitle" />
...
<section class="slider_section ">
	<div class="slider_bg_box">
		<img
			src="${pageContext.request.contextPath}/resources/images/slider-bg.jpg"
			alt="">
	</div>
					...
					<div class="row">
						<div class="col-md-7 col-lg-6 ">
							<div class="detail-box">
								<h1>
									<span> Everything </span> <br> In One Place
								</h1>
				...
				<div class="container ">
					<div class="row">
						<div class="col-md-7 col-lg-6 ">
							<div class="detail-box">
								<h1>
									<span> Heaven </span> <br> For Your Life
								</h1>
								<p>Explicabo esse amet tempora quibusdam laudantium, laborum
									eaque magnam fugiat hic? Esse dicta aliquid error repudiandae
									earum suscipit fugiat molestias, veniam, vel architecto
	...
	<div class="container">
		<div class="box">
			<div class="arrival_bg_box">
				<img
					src="${pageContext.request.contextPath}/resources/images/arrival-bg.png"
					alt="">
			</div>
			<div class="row">
				<div class="col-md-6 ml-auto">
					<div class="heading_container remove_line_bt">
						<h2>Thidingyut Festival Promotion</h2>
					</div>
					<p style="margin-top: 20px; margin-bottom: 30px;">In publishing
...
<section class="product_section layout_padding">
	<div class="container">
		<div class="heading_container heading_center">
			<h2>
				Highlight <span>products</span>
			</h2>
		</div>
		<div class="row">
			<%
			List<Product> recommendedproducts = (List<Product>) request.getAttribute("prolist");
			...
			<div class="col-sm-6 col-md-4 col-lg-4">
				<div class="box">
					<div class="option_container">
						<div class="options">
							<a href="" class="option1"> Detail </a>
						</div>
					</div>
					<div class="img-box">
						<img
							src="${pageContext.request.contextPath}/resources/productImg/<%=p.getImage() %>"
							alt="">
					</div>
					<div class="detail-box d-flex flex-column">
						<h5><%=p.getName() %></h5>
						<h6><%=p.getPrice() %> MMK</h6>
						<p>
							<i class="fa fa-heart" style="color: red;"></i> <%=p.getLikecount() %>
						</p>
					</div>
				</div>
			</div>
...
<section class="product_section layout_padding">
	<div class="container">
		...
		<div class="row text-center">
			...
			%>
			<div
				class="list-group-item list-group-item-danger my-3 mx-5 d-flex justify-content-between align-items-center col-sm-12 col-md-5">
				<%=category.getCategory()%>
				<span class="badge badge-danger badge-pill"><%=category.getProducts().size()%></span>
			</div>
			<%
			}
			}
